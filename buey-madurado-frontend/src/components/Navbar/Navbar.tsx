...
export default function Navbar() {
  ...
  // Agregar/remover listener cuando el menú abre o cierra
  ...
  return (
    <nav className="fixed w-full top-0 left-0 z-50 bg-black">
      ...
      <div
        ref={menuRef}
        className={`md:hidden fixed top-20 right-0 h-auto bg-black text-white transition-all duration-500 ease-in-out overflow-hidden
