      ...
      <div className="max-w-5xl mx-auto">
        ...
        <div className="text-center mb-16 md:mb-20">
          ...
          <p className="text-gray-300 text-sm md:text-base max-w-2xl mx-auto leading-relaxed">
            Fundadores de <span className="text-amber-300 font-semibold">El Buey Madurado</span>. Dos apasionados chefs
            que vieron en la maduración de carnes un arte culinario sin igual. Su amor por la carne, por el fuego
            y por la gastronomía los llevó a crear un espacio donde cada plato cuenta una historia de
            <span className="text-amber-300 font-semibold"> tradición, técnica y devoción</span>.
          </p>
        </div>
