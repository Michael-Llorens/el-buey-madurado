      ...
      <div className="grid md:grid-cols-2 gap-10 items-stretch">
        ...
        <div className="bg-[#0f0f0f] p-8 rounded-xl border border-gray-800 shadow-lg flex flex-col">
          ...
          <div className="flex items-center justify-between mb-6">
            ...
            <a
              href="https://www.google.com/maps/dir/?api=1&destination=Av.+de+Selgas,+5,+46800+Xàtiva,+Valencia"
              target="_blank"
              rel="noreferrer"
          ...
          <div className="flex-1 space-y-4 text-gray-300">
            ...
            <p>
              <strong>Correo:</strong> elbueymadurado@gmail.com
            </p>
            <p>
              <strong>Dirección:</strong> Av. de Selgas, 5, 46800 Xàtiva,
              Valencia
            </p>
