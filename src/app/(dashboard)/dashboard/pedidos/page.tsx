    ...
    <div className="space-y-6">
      ...
      {modo === 'add' && (
        <div className="bg-gray-800 rounded-lg p-8 border border-gray-700">
          ...
          <PedidoForm modo="add" onGuardar={handleGuardar} onCancelar={handleCancelar} />
        </div>
      )}
                ...
                <div className="bg-gray-900/40 rounded p-4 border border-gray-700">
                  ...
                  <p className="text-white">
                    {pedidoDetalle.createdAt
                      ? new Date(pedidoDetalle.createdAt).toLocaleString('es-ES')
                      : '-'}
                  </p>
                </div>
                    ...
                    return (
                      ...
                      >
                        ...
                        <div className="text-right">
                          <p className="text-amber-400 font-bold">{Number(item.subtotal || 0).toFixed(2)}€</p>
                        </div>
                      </div>
                    );
                  })}
